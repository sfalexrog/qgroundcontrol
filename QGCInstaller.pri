...
installer {
    ...
    AndroidBuild {
        ...
        QMAKE_POST_LINK += && androiddeployqt --input android-libQGroundControl.so-deployment-settings.json --output $${DESTDIR}/android-build --deployment bundled --gradle --sign $${BASEDIR}/android/coex_keystore.jks qgc_coex_key --storepass $$(ANDROID_STOREPASS) --keypass $$(ANDROID_KEYPASS)
